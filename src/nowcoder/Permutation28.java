...
public class Permutation28 {
	...
	public static void main(String[] args) {
		...
		Permutation28 sol = new Permutation28();
		ArrayList<String> res = sol.Permutation("abc");
		for(String a : res) {
	...
	public void PermutationHelper(char[] charArray, int i, ArrayList<String> res) {
		// TODO Auto-generated method stub
		if(i == charArray.length-1) {
			if(!res.contains(new String(charArray))) {
				res.add(new String(charArray)); //用这种方式能形成字符串？？
				return;
			}
		}else {
